...
import {teacher_info_for_reservation,get_waiting_time} from '../../../../Api/afterAuth'
  ...
  componentDidMount = async () => {
    ...
    // console.log("getting inside the function date_slot time_slot " ,time_slot,                reserve_date)
      ...
      let teacherId =  await AsyncStorage.getItem("teacher_id")
       let  teacher_id = JSON.parse(teacherId)
...
{/* <CountDown
        ...
        /> */}
              ...
              :<View style={{justifyContent:'center',alignItems:'center'}}>
              <Text style={{fontSize:16,textAlign:'center',fontWeight:'700'}}>No record Found!</Text>
            </View>
            }
